...
const csvWriter = createCsvWriter({
    path: '/home/fjaved/demos/hardhat-polygon/test/test_FL/registration_50x1_log.csv',
    header: [
...
const logFilePath = '/home/fjaved/demos/hardhat-polygon/test/test_FL/registration_50x1_log.txt';
...
async function main() {
    ...
    const clientRegistration = new ethers.Contract(
        "0x1a323c4E14F6D76E763e57fbA6272D264235C451",
